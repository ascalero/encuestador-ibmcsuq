...
public class PanelMiembro extends JXFrame implements ActionListener{
    ...
    foo=lenguaje;
    strTemp[0]="Selecciona el tipo de Usuario que eres";strTemp[1]="Select the type of user you are";strTemp[2]="";strTemp[3]="";
    ...
    private void initComp(){
        ...
        strTemp[0]="Escoje el tipo de Usuario";strTemp[1]="Choose the type of User";strTemp[2]="";strTemp[3]="";
        panelBotones.setBorder(BorderFactory.createTitledBorder(strTemp[foo]));
        strTemp[0]="Administrador";strTemp[1]="Administrator";strTemp[2]="";strTemp[3]="";
        butAdmon= new JButton(strTemp[foo]);
       butAdmon.addActionListener(this);
       strTemp[0]="Encuestado";strTemp[1]="tester";strTemp[2]="";strTemp[3]="";
       ...
       butClient.addActionListener(this);
        ...
        strTemp[0]="Nombre De Usuario";strTemp[1]="Nickname";strTemp[2]="";strTemp[3]="";
        ...
        strTemp[0]="Empezar Encuesta?";strTemp[1]="Start Survey?";strTemp[2]="";strTemp[3]="";
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==butAdmonLogin){
            if (taNombreUser.getText().equals("")){
                ...
                if (temo.equals("")){
                    strTemp[0]="Introduce tu Contraseña";strTemp[1]="Provide your Password";strTemp[2]="";strTemp[3]="";
                    JOptionPane.showMessageDialog(null,strTemp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
                    ...
                    switch(h){
                        ...
                        case 2:
                            ...
                            strTemp[1]="Wrong Password"; strTemp[2]="";strTemp[3]="";
                            JOptionPane.showMessageDialog(null,strTemp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
                            taContra.setText("");
                            break;
                        case 3:
                            strTemp[0]="El Usuario NO existe";
                            strTemp[1]="Username does not exist";strTemp[2]="";strTemp[3]="";
                            JOptionPane.showMessageDialog(null,strTemp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
