 ...
 * @author Ascalero
 */
public class PanelNewOQuiz extends javax.swing.JPanel implements ActionListener {
    ...
    public PanelNewOQuiz(int foobar,String Usu) {
        foo=foobar;
        USER=Usu;
    ...
    private void initComponents() {
        ...
        jBIQima2.addActionListener(this);
        jBIQima3.setText("jButton3");
        jBIQima3.addActionListener(this);
        jBIQima4.setText("jButton4");
        jBIQima4.addActionListener(this);
        jldirIQ1.setText("...");
        ...
        jBaddQGrid.addActionListener(this);
    ...
    private String[] getDirecString(){
        String[] beta= new String[4];
        strtmp[0]="Debe Selecciona Archivo";strtmp[1]="Must Select File";strtmp[2]="Muss Datei auswählen";strtmp[3]="Doit Sélectionnez Fichier";
        if (jldirIQ1.getText().equals("...")){
            JOptionPane.showMessageDialog(null,strtmp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
            return null;}
        beta[0]=jldirIQ1.getText();
        if (jldirIQ2.getText().equals("...")){
            JOptionPane.showMessageDialog(null,strtmp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
            return null;}
        beta[1]=jldirIQ2.getText();
        if (jldirIQ3.getText().equals("...")){
            JOptionPane.showMessageDialog(null,strtmp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
            return null;}
        beta[2]=jldirIQ3.getText();
        if (jldirIQ4.getText().equals("...")){
            JOptionPane.showMessageDialog(null,strtmp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
            return null;}
        beta[3]=jldirIQ4.getText();
    return beta;
    }
    
    private String getDirImaFile(){
        File fileName;
        jfcima= new JFileChooser();
        fnef =new FileNameExtensionFilter("Only image","jpg","png");
        jfcima.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
        jfcima.setFileFilter(fnef);
                    int returnVal = jfcima.showOpenDialog(this);
                    if (returnVal == JFileChooser.APPROVE_OPTION)
                        {
                            fileName = jfcima.getSelectedFile();
                            if ( ( fileName == null ) || ( fileName.getName().equals( "" ) ) )return"...";
                            try{
                                byte[] contenidoFichero = new byte[(int)fileName.length()];
                                FileInputStream fileIS=new FileInputStream(fileName);
                                fileIS.read(contenidoFichero);
                                fileIS.close();
                                String dir=System.getProperty("user.dir");
                                dir=dir+"\\src\\ima\\data\\"+structura.getName();
                                System.out.println("direction"+dir);
                                try{new File(dir).mkdir();}catch(Exception e){}
                                File fichero = new File (dir,fileName.getName());
                                if (fichero.createNewFile())
                                    System.out.println("El fichero se ha creado correctamente");
                                else{
                                    System.out.println("No ha podido ser creado el fichero");return "...";}
                                    FileOutputStream fileOS=new FileOutputStream(fichero);
                                    fileOS.write(contenidoFichero);
                                    fileOS.flush();
                                    fileOS.close();
                                return "../ima/data/"+structura.getName()+"/"+fileName.getName();
    ...
    String[] beta= new String[4];
        strtmp[0]="Falta Traduccion";strtmp[1]="Missing Translation";strtmp[2]="fehlende Ãœbersetzung";strtmp[3]="Traduction manquante";
    ...
    public void setIdioma(int foobar){
        ...
        strtmp[0]="Frances";strtmp[1]="French";strtmp[2]="FranzÃ¶sisch";strtmp[3]="FranÃ§ais"; 
        jlPregFra.setText(strtmp[foo]);
        strtmp[0]="Selecciona Tipo Pregunta";strtmp[1]="Select type of question";strtmp[2]="WÃ¤hlen Sie die Art von Frage";strtmp[3]="SÃ©lectionnez le type de question"; 
        ...
        strtmp[0]="Selecciona Libre o LikeIT";strtmp[1]="Select Free or Like IT";strtmp[2]="Ã¤hlen frei oder wie es";strtmp[3]="SÃ©lectionnez libre ou comme il";
        ...
        strtmp[0]="Agrega las 4 imagenes";strtmp[1]="Add the 4 images";strtmp[2]="FÃ¼gen Sie die 4 Bilder";strtmp[3]="Ajouter les 4 images";
        ...
        strtmp[0]="Agregar";strtmp[1]="ADD NEW";strtmp[2]="hinzufÃ¼gen neuer";strtmp[3]="ajouter de nouveaux";
        ...
        strtmp[2]="WÃ¤hlen Sie ein Hintergrundbild fÃ¼r die Verfolgung von";
        strtmp[3]="SÃ©lectionnez un arriÃ¨re-plan pour le suivi";
        ...
        strtmp[0]="Guardar Encuesta";strtmp[1]="Save Survey";strtmp[2]="Speichern Umfrage";strtmp[3]="Enregistrer EnquÃªte";
    ...
    private void setBorderFactory(int type){
        ...
        switch(foo){
            ...
            case 2 :val[0]="frei oder wie es";val[1]="WÃ¤hlen Sie das Bild";val[2]="MouseTraking";break;
    ...
    private void setTypePreg(JComboBox jcb){
        ...
        switch(foo){
            case 0 :val[0]="Libre o LikeIt";val[1]="Selecciona Imagen";val[2]="MouseTraking";break;
            case 1 :val[0]="Free or Like IT";val[1]="Select Image";val[2]="MouseTraking";break;
            case 2 :val[0]="libre ou comme il";val[1]="Whlen Sie das Bild";val[2]="MouseTraking";break;
    ...
    private void addNewQG(){
            String quest[],dir[];
            if(getStringQuest()==null) return;
            quest=getStringQuest();
            if(jRBBlanco.isSelected()){
                structura.addStQG(quest,"../../ima/blanco.png");
            }
            if(jRBMalla.isSelected()){
                structura.addStQG(quest,"../../ima/cuadricula.png");
            }
            if(jRBLibre.isSelected()){
                String direc=getDirImaFile();
                if(direc.equals("..."))return;
                direc="../"+direc;
                structura.addStQG(quest, direc);
            }
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==jbaddNQ){
            ...
            if(e.getSource()==jBIQima1){
                jldirIQ1.setText(getDirImaFile());
            }
            if(e.getSource()==jBIQima2){
                jldirIQ2.setText(getDirImaFile());
            }
            if(e.getSource()==jBIQima3){
                jldirIQ3.setText(getDirImaFile());
            }
            if(e.getSource()==jBIQima4){
                jldirIQ4.setText(getDirImaFile());
            }
        if(e.getSource()==jbAddIQ){
            String quest[],dir[];
            if(getStringQuest()==null) return;
            quest=getStringQuest();
            if(getDirecString()==null) return;
            dir=getDirecString();
            structura.addStIQ(quest, dir);
            UpdateList(structura.cloneSurvey());
            limpiaCampos();
        }
        if(e.getSource()==jBaddQGrid){
        addNewQG();
        }
        if (e.getSource()==jBANE){
            if(structura.isEmpy()){
                strtmp[0]="Agrega al menos 1 Pregunta";strtmp[1]="Add at least 1 Question";strtmp[2]="Fügen Sie mindestens 1 Frage";strtmp[3]="Ajouter au moins 1 question";
                JOptionPane.showMessageDialog(null,strtmp[foo],"MSG",JOptionPane.INFORMATION_MESSAGE);
            return;
            }
